...
<div class="stack-lg">
    <section class="card">
        ...
        <div class="result-summary-grid" style="margin-top:1rem">
            <div class="card-soft" style="padding:.75rem;border-radius:.75rem;">
                ...
                <strong id="quiz-score-text" style="font-size:1.05rem;">{{ $quiz->total_awarded_score !== null ? number_format((float) $quiz->total_awarded_score, 2) : 'Pending' }} / {{ number_format((float) $quiz->total_possible_score, 2) }}</strong>
            </div>
            <div class="card-soft" style="padding:.75rem;border-radius:.75rem;">
    ...
    <section class="stack-md">
        @foreach($quiz->quizQuestions as $quizQuestion)
            ...
            @endphp
            <article class="card stack-sm" data-answer-id="{{ $answer?->id }}">
                <div class="row-between">
